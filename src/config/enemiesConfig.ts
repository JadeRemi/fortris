...
export const ENEMY_TYPES = {
  SKULL: {
    ...
    width: 1,
    height: 1,
    assetPath: '/src/assets/images/skull.png',
    assetWidth: 64,
    assetHeight: 64,
    health: 10,
    spawnWeight: 0.5
  ...
  SLIME: {
    ...
    width: 2,
    height: 2,
    assetPath: '/src/assets/images/slime.png',
    assetWidth: 128,
    assetHeight: 128,
    health: 10,
    spawnWeight: 0.25
  ...
  LICH: {
    ...
    width: 1,
    height: 2,
    assetPath: '/src/assets/images/lich.png',
    assetWidth: 64,
    assetHeight: 128,
    health: 10,
    spawnWeight: 0.20
  ...
  OGRE: {
    ...
    width: 3,
    height: 3,
    assetPath: '/src/assets/images/ogre.png',
    assetWidth: 128,
    assetHeight: 128,
    health: 10,
    spawnWeight: 0.05
  ...
  SKELETON: {
    ...
    width: 1,
    height: 1,
    assetPath: '/src/assets/images/skeleton.png',
    assetWidth: 128,
    assetHeight: 128,
    health: 10,
